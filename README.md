...
Создайте файл `.env` в корневом каталоге бэкенда на основе `.env.example`.
Для корректной работы всех узлов графа, мониторинга и подключения баз данных заполните параметры.
